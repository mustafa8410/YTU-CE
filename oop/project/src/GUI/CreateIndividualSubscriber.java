 ...
 * @author Mustafa
 */
public class CreateIndividualSubscriber extends javax.swing.JFrame {

    /**
     * Creates new form CreateSubscriber
     */
    public CreateIndividualSubscriber() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Please provide proper information to create a new subscriber.");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String cardNo = jTextField1.getText().trim();
        String month = jTextField2.getText().trim();
        String year = jTextField6.getText().trim();
        String ccv = jTextField3.getText().trim();
        Individual is = new Individual(name,address,cardNo,Integer.parseInt(month),Integer.parseInt(year),Integer.parseInt(ccv));
        boolean check = MainGUI.distributor.addSubscriber(is);
        if(!check){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CreateIndividualSubscriber.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
